...
class Keyboard:
    ...
    # def mouse_move_right_button_down(self, event_x, event_y):
    #     for k in self.keys:
    #         if k.key_top_right_x <= event_x <= (k.key_top_right_x + k.key_width) and (
    #                 k.key_top_right_y) <= event_y <= (k.key_top_right_y + k.key_height):
    #             pass
